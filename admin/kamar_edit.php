...
if (isset($_POST['edit_kamar'])) {
    ...
    if ($nomor && $harga > 0) {
        ...
        if (mysqli_query($conn, $sql)) {
            header('Location: kamar.php?msg=edit_sukses');
            exit;
        } else {
            $pesan = '<div class="alert alert-danger">Gagal mengedit kamar.</div>';
        }
    } else {
...
<html>
<head>
    <title>Edit Kamar - Admin Kos</title>
    <meta charset="utf-8">
            ...
            <div class="card-body">
                <form method="post" class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="nomor" name="nomor" value="<?php echo htmlspecialchars($kamar['nomor']); ?>" required>
                    </div>
                    <div class="col-md-6">
                        <label for="harga" class="form-label">Harga Sewa</label>
                        <input type="number" class="form-control" id="harga" name="harga" min="1" value="<?php echo $kamar['harga']; ?>" required>
                    </div>
                    <div class="col-12">
                        <button type="submit" name="edit_kamar" class="btn btn-primary">Simpan Perubahan</button>
